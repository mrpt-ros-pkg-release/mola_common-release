## mola_common (noetic) - 0.4.1-1

The packages in the `mola_common` repository were released into the `noetic` distro by running `/home/jlblanco/code/bloom-venv/bin/bloom-release -r noetic -y mola_common` on `Thu, 22 May 2025 20:18:31 -0000`
